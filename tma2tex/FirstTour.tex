...
m1\underset{M}{*}m2:=〈m1_{1}\underset{K}{*}m2_{1},〈(m1_{2})_{i}\underset{}{+}(m2_{2})_{i}\underset{i=1,…,m1_{2}}{|}〉〉(m1\underset{M}{\textless}m2)\textcolor{red}{Pattern not found! TagBox[RowBox[{:, , ⟺}], Identity, SyntaxForm -> a⟺b]} \left(m1_{2}\textless_{lex}m2_{2}\right) \graysquare{}\end{tmaenvironment}
...
x\subseteqy:=\left(\underset{z}{\forall}\left(z\inx \Rightarrow z\iny\right)\right) \graysquare{}\end{tmaenvironment}
\light{Cell reached} \begin{openenvironment}
\end{openenvironment}\begin{tmaenvironment}
\subsection{Proposition (transitivity of \subseteq)}
\underset{a,b,c}{\forall}\left(\left(a\subseteqb \land b\subseteqc\right) \Rightarrow a\subseteqc\right) \graysquare{}\end{tmaenvironment}
