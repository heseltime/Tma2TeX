...
\begin{tmaenvironment}
\subsection{[?]}
 Forall[unexpected number of arguments,  EqualDef[ SubsetEqual[ x,  y],  Forall[ z,  Implies[ Element[ z,  x],  Element[ z,  y]]]]]\end{tmaenvironment}
 \graysquare{}\light{Cell reached} \begin{openenvironment}
\end{openenvironment}\begin{tmaenvironment}
\subsection{Proposition (transitivity of \subseteq)}
 Forall[unexpected number of arguments,  Implies[ And[ SubsetEqual[ a,  b],  SubsetEqual[ b,  FrontEnd`FileName[{$RootDirectory, C:, Users, jackh, git, repository, tma2tex}, FirstTour.nb, CharacterEncoding -> UTF-8]]],  SubsetEqual[ a,  FrontEnd`FileName[{$RootDirectory, C:, Users, jackh, git, repository, tma2tex}, FirstTour.nb, CharacterEncoding -> UTF-8]]]]\end{tmaenvironment}
